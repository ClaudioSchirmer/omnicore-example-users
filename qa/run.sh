...
SELF_SUITES="audit cache authz schema_evolution rebuild_scale config_validation migrations tracing status_mapping probes http_hardening view_options projection_convergence httpclient_middleware lifecycle_hooks filter_operators aggregates upstream_composition composed_view external_embed link_in_child integration_events transport auth grpc grpcclient grpc_security"
