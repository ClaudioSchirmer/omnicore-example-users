...
import (
	...
	context "context"
	errors "errors"
	usersv1 "github.com/ClaudioSchirmer/omnicore-example-users/proto/gen/usersv1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// UsersServiceArchiveUserProcedure is the fully-qualified name of the UsersService's ArchiveUser
	// RPC.
	UsersServiceArchiveUserProcedure = "/users.v1.UsersService/ArchiveUser"
)
...
type UsersServiceClient interface {
	...
	ArchiveUser(context.Context, *connect.Request[usersv1.ArchiveUserRequest]) (*connect.Response[usersv1.ArchiveUserResponse], error)
}
...
func NewUsersServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UsersServiceClient {
	...
	usersServiceMethods := usersv1.File_users_v1_users_proto.Services().ByName("UsersService").Methods()
	return &usersServiceClient{
		...
		archiveUser: connect.NewClient[usersv1.ArchiveUserRequest, usersv1.ArchiveUserResponse](
			httpClient,
			baseURL+UsersServiceArchiveUserProcedure,
			connect.WithSchema(usersServiceMethods.ByName("ArchiveUser")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type usersServiceClient struct {
	...
	archiveUser *connect.Client[usersv1.ArchiveUserRequest, usersv1.ArchiveUserResponse]
}
...
// ArchiveUser calls users.v1.UsersService.ArchiveUser.
func (c *usersServiceClient) ArchiveUser(ctx context.Context, req *connect.Request[usersv1.ArchiveUserRequest]) (*connect.Response[usersv1.ArchiveUserResponse], error) {
	return c.archiveUser.CallUnary(ctx, req)
}
...
func NewUsersServiceHandler(svc UsersServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	usersServiceArchiveUserHandler := connect.NewUnaryHandler(
		UsersServiceArchiveUserProcedure,
		svc.ArchiveUser,
		connect.WithSchema(usersServiceMethods.ByName("ArchiveUser")),
		connect.WithHandlerOptions(opts...),
	)
	return "/users.v1.UsersService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case UsersServiceArchiveUserProcedure:
			usersServiceArchiveUserHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedUsersServiceHandler) ArchiveUser(context.Context, *connect.Request[usersv1.ArchiveUserRequest]) (*connect.Response[usersv1.ArchiveUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("users.v1.UsersService.ArchiveUser is not implemented"))
}
