...
func (eng) Translations() map[string]string {
	return map[string]string{
		...
		"ProductCategoryLimitNotification": "Distinct product category limit reached.",
		...
		"PersonEthnicityField":           "Ethnicity",
		"UserProfileField":               "Profile",
		"UserNotificationEmailField":     "Notification email",
		"UserNotificationFrequencyField": "Notification frequency",
		...
		"DependentHealthPlanTypeField":             "Health plan type",
		...
		"UnknownRelationshipNotification":          "Unknown relationship (use spouse, son, daughter, father, mother or other).",
		"UnknownEthnicityNotification":             "Unknown ethnicity.",
		"UnknownAddressTypeNotification":           "Unknown address type.",
		"UnknownUserProfileNotification":           "Unknown user profile.",
		"UnknownNotificationFrequencyNotification": "Unknown notification frequency.",
		"UnknownHealthPlanTypeNotification":        "Unknown health plan type.",
		"InvalidHealthPlanCardNotification":        "Invalid health plan card.",
