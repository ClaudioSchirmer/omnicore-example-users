...
func (deu) Translations() map[string]string {
	return map[string]string{
		...
		"PersonEthnicityField":           "Ethnizität",
		"UserProfileField":               "Profil",
		"UserNotificationEmailField":     "Benachrichtigungs-E-Mail",
		"UserNotificationFrequencyField": "Benachrichtigungshäufigkeit",
		...
		"DependentHealthPlanTypeField":             "Krankenversicherungstyp",
		...
		"UnknownRelationshipNotification":          "Unbekannter Verwandtschaftsgrad (verwenden Sie spouse, son, daughter, father, mother oder other).",
		"UnknownEthnicityNotification":             "Unbekannte Ethnizität.",
		"UnknownAddressTypeNotification":           "Unbekannter Adresstyp.",
		"UnknownUserProfileNotification":           "Unbekanntes Benutzerprofil.",
		"UnknownNotificationFrequencyNotification": "Unbekannte Benachrichtigungshäufigkeit.",
		"UnknownHealthPlanTypeNotification":        "Unbekannter Krankenversicherungstyp.",
		"InvalidHealthPlanCardNotification":        "Ungültige Krankenversicherungskarte.",
