...
func (fra) Translations() map[string]string {
	return map[string]string{
		...
		"PersonEthnicityField":           "Origine ethnique",
		"UserProfileField":               "Profil",
		"UserNotificationEmailField":     "E-mail de notification",
		"UserNotificationFrequencyField": "Fréquence de notification",
		...
		"AddressTypeField":               "Type d'adresse",
		...
		"DependentHealthPlanTypeField":             "Type d'assurance santé",
		...
		"UnknownRelationshipNotification":          "Lien de parenté inconnu (utilisez spouse, son, daughter, father, mother ou other).",
		"UnknownEthnicityNotification":             "Origine ethnique inconnue.",
		"UnknownAddressTypeNotification":           "Type d'adresse inconnu.",
		"UnknownUserProfileNotification":           "Profil utilisateur inconnu.",
		"UnknownNotificationFrequencyNotification": "Fréquence de notification inconnue.",
		"UnknownHealthPlanTypeNotification":        "Type d'assurance santé inconnu.",
		"InvalidHealthPlanCardNotification":        "Carte d'assurance santé invalide.",
