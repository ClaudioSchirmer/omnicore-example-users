...
func (nld) Translations() map[string]string {
	return map[string]string{
		...
		"PersonEthnicityField":           "Etniciteit",
		"UserProfileField":               "Profiel",
		"UserNotificationEmailField":     "Notificatie-e-mail",
		"UserNotificationFrequencyField": "Notificatiefrequentie",
		...
		"DependentHealthPlanTypeField":             "Zorgverzekeringstype",
		...
		"UnknownRelationshipNotification":          "Onbekende verwantschap (gebruik spouse, son, daughter, father, mother of other).",
		"UnknownEthnicityNotification":             "Onbekende etniciteit.",
		"UnknownAddressTypeNotification":           "Onbekend adrestype.",
		"UnknownUserProfileNotification":           "Onbekend gebruikersprofiel.",
		"UnknownNotificationFrequencyNotification": "Onbekende notificatiefrequentie.",
		"UnknownHealthPlanTypeNotification":        "Onbekend zorgverzekeringstype.",
		"InvalidHealthPlanCardNotification":        "Ongeldige zorgverzekeringskaart.",
