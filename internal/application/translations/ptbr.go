...
func (ptbr) Translations() map[string]string {
	return map[string]string{
		...
		"UserNotificationEmailField":     "E-mail de notificação",
		"UserNotificationFrequencyField": "Frequência de notificação",
		...
		"AddressTypeField":               "Tipo de endereço",
		...
		"DependentHealthPlanTypeField":             "Tipo de plano de saúde",
		...
		"UnknownRelationshipNotification":          "Parentesco desconhecido (use spouse, son, daughter, father, mother ou other).",
		"UnknownEthnicityNotification":             "Etnia desconhecida.",
		"UnknownAddressTypeNotification":           "Tipo de endereço desconhecido.",
		"UnknownUserProfileNotification":           "Perfil de usuário desconhecido.",
		"UnknownNotificationFrequencyNotification": "Frequência de notificação desconhecida.",
		"UnknownHealthPlanTypeNotification":        "Tipo de plano de saúde desconhecido.",
		"InvalidHealthPlanCardNotification":        "Carteira do plano de saúde inválida.",
